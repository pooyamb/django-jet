...
},{"jquery":52}],2:[function(require,module,exports){
"use strict";
...
Checkboxes.prototype = {
  ...
  addLabelToCheckbox: function addLabelToCheckbox($checkbox) {
    ...
    $('<label>').attr('for', checkboxId).insertAfter($checkbox);
  },
...
},{"jquery":52}],4:[function(require,module,exports){
"use strict";
  ...
  initDeletion: function initDeletion($inline) {
    ...
    $inline.find('.inline-related').each(function () {
      ...
      $inlineItem.find('.delete input').on('change', function () {
        $inline.find('.inline-navigation-item[data-inline-related-id="' + $inlineItem.attr('id') + '"]').toggleClass('delete', $(this).is(':checked'));
      });
    });
  },
...
},{"jquery":52}],5:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],6:[function(require,module,exports){
"use strict";
...
},{"./compact-inline":4,"jquery":52}],7:[function(require,module,exports){
"use strict";
...
},{"./../../utils/jquery-slidefade":26,"jquery":52,"jquery-ui/ui/button":44,"jquery-ui/ui/core":45,"jquery-ui/ui/dialog":46,"jquery-ui/ui/draggable":47,"jquery-ui/ui/mouse":48,"jquery-ui/ui/resizable":49,"jquery-ui/ui/widget":50}],8:[function(require,module,exports){
"use strict";
...
},{"../../utils/translate":27,"jquery":52,"jquery-ui/ui/button":44,"jquery-ui/ui/core":45,"jquery-ui/ui/dialog":46,"jquery-ui/ui/draggable":47,"jquery-ui/ui/mouse":48,"jquery-ui/ui/resizable":49,"jquery-ui/ui/widget":50}],9:[function(require,module,exports){
"use strict";
...
SideBar.prototype = {
  ...
  storePinStatus: function storePinStatus(status) {
    $.cookie('sidebar_pinned', status, {
      expires: 365,
      path: '/'
    });
  },
  addToggleButton: function addToggleButton() {
    var $button = $('<span>').addClass('sidebar-container-toggle sidebar-header-menu-icon icon-menu sidebar-toggle');
...
},{"./application-pinning":7,"./bookmarks":8,"./popup":10,"browsernizr":28,"browsernizr/test/touchevents":43,"jquery":52,"jquery.cookie":51,"perfect-scrollbar/jquery":53}],10:[function(require,module,exports){
"use strict";
...
},{"../../utils/jquery-icontains":25,"browsernizr":28,"browsernizr/test/touchevents":43,"jquery":52}],11:[function(require,module,exports){
"use strict";
...
ActionsUpdater.prototype = {
  ...
  moveActions: function moveActions($actions) {
    ...
    $actions.detach();
    $paginator.detach();
    $wrapper.append($actions).append($paginator).append($('<div>').addClass('cf'));
  },
  run: function run() {
...
},{"jquery":52}],12:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],13:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],14:[function(require,module,exports){
"use strict";
...
ChangeFormTabsUpdater.prototype = {
  ...
  createTabs: function createTabs($contentWrappers, tabs) {
    ...
    $.each(tabs, function () {
      var tab = this;
      var $item = $('<li>').addClass('changeform-tabs-item');
      var $link = $('<a>').addClass('changeform-tabs-item-link').html(tab.title).attr('href', '#/tab/' + tab.className + '/');
      $link.appendTo($item);
      $item.appendTo($tabs);
    });
...
},{"../utils/translate":27,"jquery":52}],15:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],16:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],17:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],18:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],19:[function(require,module,exports){
"use strict";
...
RelatedWidgetWrapperUpdater.prototype = {
  replaceLinkIcon: function replaceLinkIcon(selector) {
    var $img = $(selector);
    $('<span>').addClass('related-widget-wrapper-icon').insertAfter($img);
    $img.remove();
  },
...
},{"jquery":52}],20:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],21:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],22:[function(require,module,exports){
"use strict";
    ...
    $changelist.find('#changelist-filter').children().each(function () {
      ...
      if ($element.prop('tagName') == 'H3') {
        ...
        $items.each(function (i) {
          ...
          var $option = $('<option>').text($link.text()).attr('data-url', $link.attr('href')).attr('selected', $item.hasClass('selected'));
          ...
          if (i == 0) {
            ...
            var $separator = $('<option>').attr('disabled', true).text('---');
            $option = $option.add($separator);
          }

          $select.append($option);
        });
        var $wrapper = $('<span>').addClass('changelist-filter-select-wrapper').append($select);
        ...
        var $wrapper = $('<span>').addClass('changelist-filter-select-wrapper').append($element);
  ...
  fixFloatLineBreak: function fixFloatLineBreak() {
    $('#content-main').each(function () {
      ...
      $.each(['#toolbar', '.object-tools', 'changeform-navigation'], function (i, selector) {
        ...
        $('<div>').addClass('clear').insertAfter($element);
        return false;
      });
    });
  },
...
},{"jquery":52}],23:[function(require,module,exports){
"use strict";
...
UserToolsUpdater.prototype = {
  updateUserTools: function updateUserTools($usertools) {
    ...
    $('<li>').addClass('user-tools-welcome-msg').text(user).appendTo($list).on('click', function () {
      if ($(document.documentElement).hasClass('touchevents')) {
...
},{"browsernizr":28,"browsernizr/test/touchevents":43,"jquery":52}],24:[function(require,module,exports){
"use strict";
...
},{"./features/changeform-tabs":1,"./features/changelist":2,"./features/checkboxes":3,"./features/filters":5,"./features/inlines":6,"./features/sidebar/main":9,"./layout-updaters/actions":11,"./layout-updaters/branding":12,"./layout-updaters/breadcrumbs":13,"./layout-updaters/changeform-tabs":14,"./layout-updaters/delete-confirmation":15,"./layout-updaters/icons":16,"./layout-updaters/object-tools":17,"./layout-updaters/paginator":18,"./layout-updaters/related-widget-wrapper":19,"./layout-updaters/stacked-inline":20,"./layout-updaters/tabular-inline":21,"./layout-updaters/toolbar":22,"./layout-updaters/user-tools":23,"jquery":52}],25:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],26:[function(require,module,exports){
"use strict";
...
},{"jquery":52}],27:[function(require,module,exports){
"use strict";
...
},{"./lib/Modernizr":29,"./lib/ModernizrProto":30,"./lib/classes":31,"./lib/setClasses":39,"./lib/testRunner":40}],29:[function(require,module,exports){
...
},{"./ModernizrProto.js":30}],30:[function(require,module,exports){
...
},{"./tests.js":42}],31:[function(require,module,exports){
...
},{"./isSVG.js":37}],33:[function(require,module,exports){
...
},{"./createElement.js":32,"./isSVG.js":37}],35:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
...
},{"./ModernizrProto.js":30,"./createElement.js":32,"./docElement.js":33,"./getBody.js":34}],36:[function(require,module,exports){
...
},{"./docElement.js":33}],38:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
  /**
...
},{"./ModernizrProto.js":30}],39:[function(require,module,exports){
...
},{"./Modernizr.js":29,"./docElement.js":33,"./isSVG.js":37}],40:[function(require,module,exports){
var tests = require('./tests.js');
var Modernizr = require('./Modernizr.js');
...
},{"./Modernizr.js":29,"./classes.js":31,"./is.js":36,"./tests.js":42}],41:[function(require,module,exports){
var ModernizrProto = require('./ModernizrProto.js');
...
},{"./ModernizrProto.js":30,"./injectElementWithStyles.js":35}],42:[function(require,module,exports){
...
},{"./../lib/Modernizr.js":29,"./../lib/prefixes.js":38,"./../lib/testStyles.js":41}],44:[function(require,module,exports){
/*!
...
},{"./src/js/adaptor/jquery":54}],54:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../main":60,"../plugin/instances":71}],55:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"./plugin/destroy":62,"./plugin/initialize":70,"./plugin/update":73}],61:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":59,"../instances":71,"../update-geometry":72}],64:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/dom":56,"../../lib/helper":59,"../instances":71,"../update-geometry":72}],65:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":59,"../instances":71,"../update-geometry":72}],66:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":59,"../instances":71,"../update-geometry":72}],67:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../../lib/helper":59,"../instances":71,"../update-geometry":72}],69:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../instances":71,"../update-geometry":72}],70:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/dom":56,"../lib/event-manager":57,"../lib/guid":58,"../lib/helper":59,"./default-setting":61}],72:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/class":55,"../lib/dom":56,"../lib/helper":59,"./instances":71}],73:[function(require,module,exports){
/* Copyright (c) 2015 Hyunje Alex Jun and other contributors
 * Licensed under the MIT License
 */
'use strict';
...
},{"../lib/dom":56,"../lib/helper":59,"./instances":71,"./update-geometry":72}]},{},[24]);
