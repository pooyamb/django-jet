...
latex_documents = [(master_doc, 'DjangoJET.tex', u'Django JET Documentation', u'Denis Kildishev', 'manual')]
...
man_pages = [(master_doc, 'djangojet', u'Django JET Documentation', [author], 1)]
